...
import 'package:fluttergpt/screens/premium_pages/premium_screen.dart';
...
class HomeScreenController extends GetxController {
  ...
  String selectedText =
      jsonString(Get.find<LanguageScreenController>().selectedIndex.value);
  ...
  Future<void> readJson() async {
    ...
    switch (index) {
      //
      case 0:
        jsonFile(AppAssets.enUS);
        break;

      case 1:
        jsonFile(AppAssets.esPY);
        break;

      case 2:
        jsonFile(AppAssets.frCA);
        break;

      case 3:
        jsonFile(AppAssets.deDE);
        break;

      case 4:
        jsonFile(AppAssets.zhCN);
        break;

      case 5:
        jsonFile(AppAssets.ruRu);
        break;

      case 6:
        jsonFile(AppAssets.hiIN);
        break;

      case 7:
        jsonFile(AppAssets.arSAU);
        break;

      case 8:
        jsonFile(AppAssets.ptPRT);
        break;

      case 9:
        jsonFile(AppAssets.idIDN);
        break;

      case 10:
        jsonFile(AppAssets.nlNLD);
        break;

      case 11:
        jsonFile(AppAssets.itITA);
        break;

      case 12:
        jsonFile(AppAssets.plPOL);
        break;

      case 13:
        jsonFile(AppAssets.trTUR);
        break;

      case 14:
        jsonFile(AppAssets.jaJPN);
        break;
    }
